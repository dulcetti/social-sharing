      ...
      <S.ButtonShare onClick={toggleMenu} className='button'>
        ...
        >
          <g>
            ...
            />
            <circle fill={shareCircle} r='4.63598' cy='4.695453' cx='18.667982' />
            <circle fill={shareCircle} r='4.63598' cy='11.980565' cx='5.422325' />
            <circle fill={shareCircle} r='4.63598' cy='19.265676' cx='18.667982' />
          </g>
        </svg>
        <S.LabelShare>
          <svg
            ...
            viewBox='0 0 80 80'
          >
            <path id='semi-circle' d='M13,20 A22,15 0 0,0 68,18' fill='none' />
      ...
      <S.ShareList className={`${showSubMenu ? '-opened' : ''} list`}>
        ...
        <S.ShareItem className='item -whatsapp'>
          ...
          >
            ...
            >
              <g>
                <circle r='15.687307' fill={bgWhatsapp} cy='15.937338' cx='15.937338' />
                <path
                  fill={colorSvgs}
